...
export class CampaignController {
    ...
    async getAll(req, res) {
		try {
			...
			defaultReturnStatement(res, "Campaigns", Promise.resolve(campaigns));
		} catch (err) {
			console.error(err);
    ...
    async getCampaignById(req, res) {
		try {
			...
			defaultReturnStatement(res, "Campaign", Promise.resolve(campaign));
		} catch (err) {
			console.error(err);
			res.status(500).json({ status: 500, error: err });
		}
    ...
    async createCampaign(req, res) {
		try {
			...
			defaultReturnStatement(res, "Campaign Created", Promise.resolve(campaign));
		} catch (err) {
			console.error(err);
			res.status(500).json({ status: 500, error: err });
		}
    ...
    async createCampaignCustomerAssociation(req, res) {
		try {
			...
			defaultReturnStatement(res, "Customer Association Created", Promise.resolve(association));
		} catch (err) {
			console.error(err);
			res.status(500).json({ status: 500, error: err });
		}
    ...
    async updateCampaign(req, res) {
		try {
			...
			defaultReturnStatement(res, "Campaign Updated", Promise.resolve(campaign));
		} catch (err) {
			console.error(err);
			res.status(500).json({ status: 500, error: err });
		}
